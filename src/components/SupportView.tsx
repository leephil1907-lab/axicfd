...
const FAQ_ENTRIES: FAQItem[] = [
  // 1. Account Setup & Verification
  {
    ...
    answer: 'Identity verification is a 2-step process to ensure AML compliance: 1) Upload a clear photo of a Government ID (Passport, Driving License, or National ID) and 2) Upload a Proof of Address document (Utility bill or bank statement within 90 days). Verification is reviewed manually by our compliance team. Typical review time is 1–24 hours after both ID and proof of address are submitted. Status only changes after an admin approves your documents.'
  },
  {
    id: 'faq-2',
    category: 'General Account Setup',
