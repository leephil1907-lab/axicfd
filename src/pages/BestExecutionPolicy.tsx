...
export default function BestExecutionPolicy() {
  return (
    <div className="min-h-screen bg-[#FAF8F5]">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
          <h1 className="text-3xl font-bold text-gray-900 mb-8">Best Execution Policy</h1>

          <div className="space-y-6 text-gray-700">
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-3">1. Introduction</h2>
              <p className="leading-relaxed">This Best Execution Policy governs your use of AXI Trading services. By accessing or using our platform, you agree to be bound by these terms.</p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">For questions regarding this Best Execution Policy, contact us at legal@axi-trading.com or call +1-800-888-8888.</p>
            </section>
          </div>
